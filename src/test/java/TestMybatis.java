...
/**
 * Created by HuangHailiang on 2017/2/22.
 */
public class TestMybatis {
    ...
    public void testQueryUser(){
        ...
        try {
            User user = session.selectOne("com.guliang.dao.UserMapper.selectUserDetail", 1);
...
//            user.setUserAge("15") ;
//            user.setUserAdress("hangzhou/zhejiang");
...
//            user.setUserAge("101") ;
//            user.setUserAdress("shenzhen/guangdong");
